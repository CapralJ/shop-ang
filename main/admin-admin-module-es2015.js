...
/* harmony import */ var src_app_shared_product_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/product.service */ "./src/app/shared/product.service.ts");
...
let AddPageComponent = class AddPageComponent {
    constructor(productServ, router) {
...
AddPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/add-page/add-page.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-page.component.scss */ "./src/app/admin/add-page/add-page.component.scss")).default]
    })
], AddPageComponent);
...
/* harmony import */ var _add_page_add_page_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./add-page/add-page.component */ "./src/app/admin/add-page/add-page.component.ts");
/* harmony import */ var _orders_page_orders_page_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./orders-page/orders-page.component */ "./src/app/admin/orders-page/orders-page.component.ts");
...
AdminModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _add_page_add_page_component__WEBPACK_IMPORTED_MODULE_7__["AddPageComponent"],
            _edit_page_edit_page_component__WEBPACK_IMPORTED_MODULE_9__["EditPageComponent"],
            _orders_page_orders_page_component__WEBPACK_IMPORTED_MODULE_8__["OrdersPageComponent"],
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild([
                {
                    path: '', component: _shared_admin_layout_admin_layout_component__WEBPACK_IMPORTED_MODULE_4__["AdminLayoutComponent"], children: [
                        ...
                        { path: 'dashboard', component: _dashboard_page_dashboard_page_component__WEBPACK_IMPORTED_MODULE_6__["DashboardPageComponent"], canActivate: [_shared_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
                        { path: 'add', component: _add_page_add_page_component__WEBPACK_IMPORTED_MODULE_7__["AddPageComponent"], canActivate: [_shared_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
                        { path: 'orders', component: _orders_page_orders_page_component__WEBPACK_IMPORTED_MODULE_8__["OrdersPageComponent"], canActivate: [_shared_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
                        { path: 'product/:id/edit', component: _edit_page_edit_page_component__WEBPACK_IMPORTED_MODULE_9__["EditPageComponent"], canActivate: [_shared_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
                    ]
                }
            ])
        ],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_shared_product_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/product.service */ "./src/app/shared/product.service.ts");
...
let EditPageComponent = class EditPageComponent {
    constructor(route, productServ, router) {
        this.route = route;
        this.productServ = productServ;
        this.router = router;
        this.submitted = false;
    ...
    ngOnInit() {
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(params => {
            ...
            this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormGroup"]({
                type: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](this.product.type, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required),
                title: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](this.product.title, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required),
                photo: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](this.product.photo, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required),
                info: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](this.product.info, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required),
                price: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](this.product.price, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required),
            });
        });
    }
    submit() {
        ...
        this.submitted = true;
        this.productServ.update(Object.assign({}, this.product, { type: this.form.value.type, title: this.form.value.title, photo: this.form.value.photo, info: this.form.value.info, price: this.form.value.price, date: new Date() })).subscribe(res => {
            this.submitted = false;
...
let OrdersPageComponent = class OrdersPageComponent {
...
OrdersPageComponent.ctorParameters = () => [
    { type: src_app_shared_order_service__WEBPACK_IMPORTED_MODULE_2__["OrderService"] }
];
OrdersPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-orders-page',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./orders-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/orders-page/orders-page.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./orders-page.component.scss */ "./src/app/admin/orders-page/orders-page.component.scss")).default]
    })
], OrdersPageComponent);
...
AdminLayoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./admin-layout.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/shared/admin-layout/admin-layout.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin-layout.component.scss */ "./src/app/admin/shared/admin-layout/admin-layout.component.scss")).default]
    })
